...
Khor'Vélyss est la cité druidique légendaire à laquelle tout [[Druide|druide]] souhaitant se lier avec l'[[Arbre de la Première Parole]] doit se rendre en pèlerinage pour communier avec l'essence de la forêt.

## Géographie : Une Cité au Cœur du Voile

Elle se dresse dans la [[Sylve d'Aerwyn]], dissimulée au sein de la région mystique et brumeuse du [[Cœur Voilé]], non loin de la lisière des [[Frondains]].
...
WHERE contains(groupe, "khor'vélyss") and contains(type, "PNJ") 
```
