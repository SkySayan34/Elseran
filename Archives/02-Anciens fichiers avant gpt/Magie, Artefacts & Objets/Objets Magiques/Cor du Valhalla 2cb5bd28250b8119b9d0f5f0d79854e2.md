...
rarete: rare (argent ou airain) très rare (bronze) ou légendaire (fer)
necessite_lien: No
source: Dungeon Master´s Guide (SRD)
description: Vous pouvez utiliser une action pour souffler dans ce cor. En réponse, des esprits guerriers venant du Valhalla apparaissent dans un rayon de 18 mètres autour de vous. Ils utilisent les statistiques du
berserker
. Ils retournent au Valhalla au bout d'une heure ou lorsqu'ils tombent à 0 point de vie. Une fois que vous avez utilisé le cor, il ne peut pas être réutilisé avant que 7 jours ne se soient écoulés.
...
url: https://www.aidedd.org/dnd/om.php?vf=cor-du-valhalla