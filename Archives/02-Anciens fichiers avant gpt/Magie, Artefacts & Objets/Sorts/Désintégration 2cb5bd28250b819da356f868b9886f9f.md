...
description: : V, S, M (de la magnétite et une pincée de poussière)
Un mince faisceau de lumière verte surgit de la pointe de votre doigt vers une cible visible dans la portée du sort. La cible peut être une créature, un objet ou une création de force magique, comme un mur façonné par
...
materiel: de la magnétite et une pincée de poussière
duree: instantanée